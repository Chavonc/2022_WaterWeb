...
<body>
    ...
    <br>
    <form method="POST" action="MemberService1_php.php">
    <div class="row">
        <div align="center">
            <h4>查詢會員資料</h4>
        </div>
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Username" aria-label="Username"
                aria-describedby="basic-addon1" name="mail">
        ...
        <button type="submit" class="btn btn-outline-primary button" style="width: default;">網路會員資料驗證</button>
    </div>
    </form>
</body>
