    ...
    <div class="row">
        ...
        <div class="shadow-sm p-3 mb-5 bg-body rounded">
            <div class="card" style="vertical-align:middle;border-style: none;">
                <br>
                <?php
                $mail = $_SESSION['mail_service'];
                $password = $_SESSION['password_service'];
