...
<body>
    ...
    <div class="row2">
        <p>
            <img src="CinemaInfoPicture/1.png" alt="一張圖片" width="100%" height="250">
            ...
            <table style="position:absolute;top:600px;left:4%;width:1000px;border: 1px solid black;">
                ...
                <tr>
                    ...
                    <td style="width:300px;"><?php echo $row_traffic['traffic_info']; ?></td>
                </tr>
            </table>
        </p>
    </div>
