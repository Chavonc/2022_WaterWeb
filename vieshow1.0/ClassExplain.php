...
<body>
    ...
    <div id="Explain">
        <h5 style="text-align:center;color:blue;">電影級數說明</h5>
        <p>
            <text style="position:absolute;left:4%;">依照新聞局規定，電影分級制度分為四級，詳細規定如下：</text>
            <br>
        <table class="center">
            <tr style="position:absolute;top:170px;left:4%;">
                <td><img src="ClassExplainPicture/1.png" width="60"></td>
                <td><text>普遍級/G (簡稱 普級)：一般觀眾皆可觀賞。</text></td>
            </tr>
            <tr style="position:absolute;top:220px;left:4%;">
                <td><img src="ClassExplainPicture/2.png" width="60"></td>
                <td><text>保護級/P (簡稱 護級)：未滿六歲之兒童不得觀賞，六歲以上十二歲未滿之兒童需父母、師長或成年親友陪伴輔導觀賞。</text></td>
            </tr>
            <tr style="position:absolute;top:270px;left:4%;">
                <td><img src="ClassExplainPicture/3.png" width="60"></td>
                <td><text>輔導級/PG(簡稱 輔級)：未滿十二歲不得觀賞。</text></td>
            </tr>
            <tr style="position:absolute;top:320px;left:4%;">
                <td><img src="ClassExplainPicture/4.png" width="60"></td>
                <td><text>輔12級/PG12(簡稱 輔12級)：未滿十二歲不得觀賞。</text></td>
            </tr>
            <tr style="position:absolute;top:370px;left:4%;">
                <td><img src="ClassExplainPicture/5.png" width="60"></td>
                <td><text>輔15級/PG15(簡稱 輔15級)：未滿十五歲不得觀賞。</text></td>
            </tr>
            <tr style="position:absolute;top:420px;left:4%;">
                <td><img src="ClassExplainPicture/6.png" width="60"></td>
                <td><text>限制級/R (簡稱 限級)：未滿十八歲不得觀賞。</text></td>
            </tr>
        </table>
        <br>
        <ul>
            <li style="position:absolute;top:480px;left:6%;">入場驗票時請出示年齡符合之證明文件。</li>
            <li style="position:absolute;top:500px;left:6%;">本網站所列電影介紹裡，皆可看到每一部影片的正確級數。</li>
            <li style="position:absolute;top:520px;left:6%;">購票及取票時請依照分級制度出示觀賞電影者年齡符合之證明文件。</li>
        </ul>
        </p>
    </div>
</body>
