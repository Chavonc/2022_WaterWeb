<?php
    ...
    $table="";
    if((isset($_GET['tabletype']))&&(isset($_GET['area']))&&($tabletype!="意外事件")&&($tabletype!="地理區域")) // tabletype=漁港 海岸 水庫 溪河
    {
        if($area=="全部"){
            if($tabletype=="溪河分析"){
                    ...
                    foreach($row as $key => $value){
                        ...
                        if(($key=="名稱")||($key=="水域ID"))
                        {
                            ...
                            elseif($key=="水域ID"){
                                ...
                                $table .= "<button style='position:absolute;left: 230px;margin-top: -25px;' name='delete' value='$Myname' class='btn btn-outline-danger btn-sm '>刪除</button>";
            ...
            foreach($rows as $row){
                ...
                foreach($row as $key => $value){
                    ...
                    if(($key=="發生地點")||($key=="事件ID"))
                    {
                        ...
                        $table .= "<button style='position:absolute;left: 330px;margin-top: -25px;' name='accidentID' value='$MyID' class='btn btn-outline-danger btn-sm '>刪除</button>";
            ...
            foreach($rows as $row){
                ...
                foreach($row as $key => $value){
                    ...
                    elseif($key=="區域ID"){
                        ...
                        $table .= "<button style='position:absolute;left: 330px;' name='areaID' value='$value' class='btn btn-outline-danger btn-sm '>刪除</button>";
        ...
        <div style="background-color:#E0E0E0;width:770px;height:550px;position:absolute;top:18%;left:31%;">
            <div style="margin:35px 50px;">
                ...
                <form method="get" action="">
                    ...
                    <?php
                        $watertable='
                        <div style="position:absolute;right:25%;top:12%;">
                        <h6>選擇縣市:</h6>
                        ...
                        echo $watertable;        
                    ?>
                    <input style="position:absolute;right:15%;top:18%;" class="btn btn-outline-secondary btn-sm" type="submit" value="Submit">
                </form>
                <?php
                    echo $table;
                ?>
