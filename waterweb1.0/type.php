<?php
    ...
    if($watertype=="水庫湖泊")
    {
        $sql = "SELECT 水庫及湖分析.名稱 ,地理區域.縣市名稱,水庫及湖分析.水域ID FROM (`水庫及湖分析` LEFT JOIN 水域景點 ON 水庫及湖分析.水域ID =水域景點.水域ID) LEFT JOIN 地理區域 ON 水域景點.區域ID = 地理區域.區域ID WHERE 地理區域.縣市名稱='".$area."'";
